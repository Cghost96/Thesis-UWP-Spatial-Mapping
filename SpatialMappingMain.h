...
{
	class SpatialMappingMain : public DX::IDeviceNotify
	{
	public:
		SpatialMappingMain(const std::shared_ptr<DX::DeviceResources>& deviceResources);
		~SpatialMappingMain();
	...
	private:
		...
		bool m_drawWirfeFrame = Options::DRAW_WIREFRAME_INIT_VALUE;
